...
public class IAController : MonoBehaviour {
    ...
    private float maxUrge;
    private float hungerChance;
    private float urgeChance;
	...
	void Start () {
        ...
        happiness = 100;
        maxHunger = Random.Range(10f, 40f);
        maxUrge = Random.Range(10f, 50f);
        hungerChance = Random.Range(0.2f, 0.6f);
        urgeChance = Random.Range(0.2f, 0.6f);
        wander = 0f;
        hunger = 0f;
        urge = 0f;
    ...
    public enum IAState
    {
        WAITING, TO_BATHROOM, TO_FOOD, TO_TABLE, BATHROOM, FOOD, WANDER
    }
}
